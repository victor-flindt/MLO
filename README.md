...
Pytorch ecosystem: Transforms. <br/>
...
The goal of the project (based on the current dataset) is to predict the sentiment of a tweet, this will give us a rough idea of what the tweet is about in buzzwords. <br/>
